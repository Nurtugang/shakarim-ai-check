...
1. СНАЧАЛА найди и проанализируй все ошибки и проблемы в тексте
2. ЗАТЕМ на основе найденных ошибок выстави соответствующие оценки по 4 критериям
3. ПОТОМ дай рекомендации по улучшению
...
Анализируй найденные ошибки и выставляй оценки в соответствии с ними. Если по грамматике нашел много ошибок - ставь низкую оценку по грамматике. Если по структуре проблем мало - ставь высокую оценку по структуре. Оценки должны логически вытекать из найденных проблем.
